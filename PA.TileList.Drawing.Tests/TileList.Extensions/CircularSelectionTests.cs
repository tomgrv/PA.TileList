...
namespace PA.TileList.Drawing.Tests.TileList.Extensions
{
    ...
    {
        private readonly CircularProfileRenderer cpr = new CircularProfileRenderer(Pens.Red, Pens.Red, Pens.Pink);
        ...
        {
            var pro = CircularTests.GetTestProfile(1000);
            var scs = new SelectionConfiguration(SelectionPosition.Inside | SelectionPosition.Under, 0.10f);
        ...
        {
            var pro = CircularTests.GetTestProfile(1000);
            var scs = new SelectionConfiguration(SelectionPosition.Inside | SelectionPosition.Under, 0.25f);
        ...
        {
            var pro = CircularTests.GetTestProfile(1000);
            var scs = new SelectionConfiguration(SelectionPosition.Inside | SelectionPosition.Under, 1f);
        ...
        {
            var pro = CircularTests.GetTestProfile(1000);
            var scs = new SelectionConfiguration(SelectionPosition.Inside, 0.10f);
        ...
        {
            var pro = CircularTests.GetTestProfile(1000);
            var scs = new SelectionConfiguration(SelectionPosition.Inside, 0.25f);
        ...
        {
            var pro = CircularTests.GetTestProfile(1000);
            var scs = new SelectionConfiguration(SelectionPosition.Inside, 1f);
        ...
        {
            var pro = CircularTests.GetTestProfile(1000);
            var scs = new SelectionConfiguration(SelectionPosition.Under, 0.10f);
        ...
        {
            var pro = CircularTests.GetTestProfile(1000);
            var scs = new SelectionConfiguration(SelectionPosition.Under, 0.25f);
        ...
        {
            var pro = CircularTests.GetTestProfile(1000);
            var scs = new SelectionConfiguration(SelectionPosition.Inside ^ SelectionPosition.Outside, 1f);
        ...
        {
            var pro = CircularTests.GetZeroProfile();
            var scs = new SelectionConfiguration(SelectionPosition.Inside | SelectionPosition.Under, 0.10f, false);
        ...
        {
            var pro = CircularTests.GetFlatProfile();
            var scs = new SelectionConfiguration(SelectionPosition.Inside | SelectionPosition.Under, 0.10f, false);
        ...
        {
            var pro = CircularTests.GetSimpleProfile();
            var scs = new SelectionConfiguration(SelectionPosition.Inside | SelectionPosition.Under, 0.10f, false);
