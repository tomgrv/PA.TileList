...
namespace PA.TileList.Drawing.Tests.TileList.Extensions
{
    ...
    public class QuadrantTest
    {
        ...
        public void ChangeQuadrant()
        {
            ...
            var signature1 =
                t1.GetImage(5000, 5000, (z, s) => z.Context.ToBitmap(100, 100, z.X + "\n" + z.Y))
            ...
            var signature2 =
                t2.GetImage(5000, 5000, (z, s) => z.Context.ToBitmap(100, 100, z.Context.X + "\n" + z.Context.Y))
            ...
            var signature3 =
                t3.GetImage(5000, 5000, (z, s) => z.Context.ToBitmap(100, 100, z.Context.X + "\n" + z.Context.Y))
            ...
            var signature4 =
                t4.GetImage(5000, 5000, (z, s) => z.Context.ToBitmap(100, 100, z.Context.X + "\n" + z.Context.Y))
